...
SELECT nextval('ec_tmp.product_category_id')                                               AS product_category_id,
       coalesce(coalesce(product_category_name_english, product_category_name), 'Unknown') AS product_category,
       coalesce(product_category_name, 'Unknown')                                          AS product_category_portuguese
